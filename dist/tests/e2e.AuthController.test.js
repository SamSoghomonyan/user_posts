...
// import { User } from "../src/entity/User";
//
// // Define an interface for the user data to improve type safety and readability
// interface UserData {
//   username: string;
//   password: string;
//   email: string;
...
//   let password = '';
//   let email = '';
//   let newUser: UserData; // Declared with the UserData interface
//
...
//       const decoded: any = jwt.verify(token, process.env.JWT_SECRET || 'my_secret_key');
//
//       const userInfo = await userRepo.findOneBy({ email: email });
//
//       expect(decoded).toHaveProperty('id');
